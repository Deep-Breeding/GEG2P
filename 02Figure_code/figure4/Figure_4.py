...
# 方法顺序（需与列顺序一致）
methods = ["DNNGP", "DeepGS", "DLGWAS", "gMLP", "LCNN",  "KNN", "RF", "XGBoost", "MLP", "SVR",
            "BayesA", "BayesB", "BayesC", "BL", "BRR", "rrBLUP", "LASSO", "SPLS", "RR", "BRNN", "GEG2P(v3)"]
...
# 设置物种名称
species_list = ["Wheat", "Rice", "Chickpea", "Soybean"]
print(blocks)
# 主循环
for i, block in enumerate(blocks):
    ...
    for trait in traits:
        ...
        if avg_row.empty or se_row.empty:
            continue
        ...
        plot_bar_manual_x(values, errors, methods, title, ylabel="PCC", ylim=ylim, colors=colors, save_path=save_path)
